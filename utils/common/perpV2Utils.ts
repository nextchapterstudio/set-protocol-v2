...
export async function leverUp(
  setToken: SetToken,
  module: PerpV2LeverageModule | PerpV2LeverageModuleV2 | PerpV2BasisTradingModule,
...
export async function calculateLeverageRatios(
  setToken: Address,
  perpModule: PerpV2LeverageModule | PerpV2LeverageModuleV2 | PerpV2BasisTradingModule,
  fixture: PerpV2Fixture,
